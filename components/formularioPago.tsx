...
const bancos = [
  ...
  { id: 2, name: 'Bancolombia', img: '/bancolombia.png', moneda: 'COP' },
...
export default function FormularioPago({ tickets, tasaVes }: FormularioProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow space-y-4"
      ...
      <div className="mb-4">
        <label htmlFor="banco" className="block mb-1 font-medium">
      ...
      <div className="flex items-center space-x-3 mt-2">
        <Image src={selectedBanco.img} alt={selectedBanco.name} className="w-10 h-10 object-contain" width={100} height={100} />
        <span className="font-medium">{selectedBanco.name}</span>
